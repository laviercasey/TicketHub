/*********************************************************************
    ...
    Peter Rotich <peter@tickethub.com>
    Copyright (c) 2006-2010 TicketHub
    http://www.tickethub.com
...
var autoLock = {
    ...
    acquireLock: function(e,warn) {      
        ...
        if(!autoLock.lockId) {
            Http.get({
                url: "dispatch.php?api=tickets&f=acquireLock&tid="+autoLock.tid,
    ...
    renewLock: function(e) {
        ...
        if(!autoLock.lastcheckTime || (now-autoLock.lastcheckTime)>=(autoLock.renewFreq*1000)){
            Http.get({
                url: "dispatch.php?api=tickets&f=renewLock&id="+autoLock.lockId+'&tid='+autoLock.tid,
                callback: autoLock.setLock
                },['renew',autoLock.warn]);
        }
    }, 
    ...
    releaseLock: function(e) {
        ...
        Http.get({
            url: "dispatch.php?api=tickets&f=releaseLock&id="+autoLock.lockId+'&tid='+autoLock.tid,
